              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-300">info@amekany.co.za</div>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-300">+27 11 123 4567</div>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-300">123 Industrial Drive, Johannesburg, South Africa</div>
                  </div>
                </div>
              </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <select className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                      <option>Food-Grade Pellets</option>
                      <option>Industrial Grade Pellets</option>
      ...
      <div className="py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#partners" className="hover:text-teal-400 transition-colors">Partners</a></li>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 Amekany (PTY) LTD. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
